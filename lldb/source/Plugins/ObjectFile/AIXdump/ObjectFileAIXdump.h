...
#ifndef LLDB_SOURCE_PLUGINS_OBJECTFILE_AIXDUMP_OBJECTFILEAIXDUMP_H
#define LLDB_SOURCE_PLUGINS_OBJECTFILE_AIXDUMP_OBJECTFILEAIXDUMP_H

#include "lldb/Symbol/ObjectFile.h"
#include "lldb/Symbol/SaveCoreOptions.h"
#include "lldb/Utility/ArchSpec.h"

class ObjectFileAIXdump : public lldb_private::PluginInterface {
public:
  // Static Functions
  static void Initialize();
  static void Terminate();

  static llvm::StringRef GetPluginNameStatic() { return "aixdump"; }
  static const char *GetPluginDescriptionStatic() {
    return "AIXdump object file.";
  }
...
private:
  ObjectFileAIXdump() = default;
};

#endif // LLDB_SOURCE_PLUGINS_OBJECTFILE_AIXDUMP_OBJECTFILEAIXDUMP_H
